...
public class Project_DB_Notifications_student {
	...
	public Project_DB_Notifications_student(String loginID)
	{
	...
	public void ui_listDueItems()
	{
		try {
			...
			newLine();
			ResultSet rs_sbookborrow = stmt.executeQuery("SELECT * FROM books B, sbookborrow BR WHERE BR.etime <=  to_date('" + sdf.format(after3Days) + "', 'mm/dd/yy hh24:mi') AND BR.etime > to_date('" + sdf.format(after2Days) + "', 'mm/dd/yy hh24:mi') AND BR.bid  = B.bid AND BR.sid = '" + loginID + "'");
			if (!rs_sbookborrow.next())
			{
				outPrintln(FIVE_SPACES + "No items!");
			}
			rs_sbookborrow.previous();
			int countIndex = 1;
			while (rs_sbookborrow.next())
			{
				String show_btitle = rs_sbookborrow.getString("btitle");
				Date dueDate = rs_sbookborrow.getTimestamp("etime");
			...
			newLine();
			rs_sbookborrow = stmt.executeQuery("SELECT * FROM books B, sbookborrow BR WHERE BR.etime <=  to_date('" + sdf.format(after1Days) + "', 'mm/dd/yy hh24:mi') AND BR.etime > to_date('" + sdf.format(curDate) + "', 'mm/dd/yy hh24:mi') AND BR.bid  = B.bid AND BR.sid = '" + loginID + "'");
			if (!rs_sbookborrow.next())
			{
				outPrintln(FIVE_SPACES + "No items!");
			}
			...
			newLine();
			rs_sbookborrow = stmt.executeQuery("SELECT * FROM books B, sbookborrow BR WHERE BR.etime <=  to_date('" + sdf.format(before30Days) + "', 'mm/dd/yy hh24:mi') AND BR.etime > to_date('" + sdf.format(before60Days) + "', 'mm/dd/yy hh24:mi') AND BR.bid  = B.bid AND BR.sid = '" + loginID + "'");
			if (!rs_sbookborrow.next())
			{
				outPrintln(FIVE_SPACES + "No items!");
			}
			...
			newLine();
			rs_sbookborrow = stmt.executeQuery("SELECT * FROM books B, sbookborrow BR WHERE BR.etime <=  to_date('" + sdf.format(before60Days) + "', 'mm/dd/yy hh24:mi') AND BR.etime > to_date('" + sdf.format(before90Days) + "', 'mm/dd/yy hh24:mi') AND BR.bid  = B.bid AND BR.sid = '" + loginID + "'");
			if (!rs_sbookborrow.next())
			{
				outPrintln(FIVE_SPACES + "No items!");
			}
			...
			newLine();
			rs_sbookborrow = stmt.executeQuery("SELECT * FROM books B, sbookborrow BR WHERE BR.etime <=  to_date('" + sdf.format(before90Days) + "', 'mm/dd/yy hh24:mi') AND BR.bid  = B.bid AND BR.sid = '" + loginID + "'");
			if (!rs_sbookborrow.next())
			{
				outPrintln(FIVE_SPACES + "No items!");
			}
			...
			ResultSet rs_scamborrow = stmt.executeQuery("SELECT * FROM scamborrow WHERE etime <  to_date('" + sdf.format(curDate) + "', 'mm/dd/yy hh24:mi') AND sid = '" + loginID + "'");
			if (rs_scamborrow.next())
			{
				newLine();
	...
	{
		Project_DB_Notifications_student pdb_noti_stu = new Project_DB_Notifications_student("S1");
	}
}