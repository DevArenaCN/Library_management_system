...
public class camera {
    ...
    public static void Camera(String userId) throws ParseException {
       ...
       // searchcam2 = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
        ...
        //Update OTMark
        String selectot = "select * from sCamBorrow";
        ...
        while(rs.next())
        {
            ...
            {
                   String updateot = "update sCamBorrow set OTMARK=0 where cam_id = \'"+camid+"\'";
                stmt.executeUpdate(updateot);
                System.out.println("========");
            }
...
//if no record in sCamBorrow you can borrow it
...

            {
                ...
                String borrowinsert = "INSERT INTO sCamBorrow VALUES( ?,?,to_date(\'"+ check_out_d +"\','mm/dd/yy HH24'),to_date(\'"+ check_in_d +"\','mm/dd/yy HH24'),0)";
            ...
            else
            {
                ...
                //String addwl = "INSERT INTO sCamWL VALUES("+sid+" "+id+" "+",to_date('"+ check_out_d +"','dd/MON/yyyy'))";
                String addwl = "INSERT INTO sCamWL VALUES( ?,?,to_date('"+ check_out_d +"','mm/dd/yy HH24'))";
