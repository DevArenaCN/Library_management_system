...
public class fcheckborrow {

    static final String jdbcURL 
	= "jdbc:oracle:thin:@ora.csc.ncsu.edu:1521:orcl";

    public static void fcheckbor(String userId) {
        try {
        ...
        //borrow book
		rs = stmt.executeQuery("SELECT * from fBookBorrow,Books where fBookBorrow.fid ='"+fid+"' and fBookBorrow.bid = Books.bid");
		...
		while (rs.next()) 
        {
            ...
            if (etime == null)
                System.out.println(fid+" "+bid+" "+btype+" "+show_bisbn+" "+show_btitle+" "+show_bedition+" "+show_bauthor+" "+show_bpublisher+" "+show_byear+" "+show_blocation+" "+stime.toString());
            else
                System.out.println(fid+" "+bid+" "+btype+" "+show_bisbn+" "+show_btitle+" "+show_bedition+" "+show_bauthor+" "+show_bpublisher+" "+show_byear+" "+show_blocation+" "+stime.toString()+" "+etime.toString());

		}
        //borrow journal
        rs = stmt.executeQuery("SELECT * from fJournalBorrow,Journal where fJournalBorrow.fid ='"+fid+"' and fJournalBorrow.jid = Journal.jid");
        ...
        while (rs.next()) 
        {
            ...
            if (etime == null)
                System.out.println(fid+" "+jid+" "+show_jisbn+" "+show_jtitle+" "+show_jauthor+" "+show_jyear+" "+stime.toString());
            else
                System.out.println(fid+" "+jid+" "+show_jisbn+" "+show_jtitle+" "+show_jauthor+" "+show_jyear+" "+stime.toString()+" "+etime.toString());

        }

        //borrow conference
        rs = stmt.executeQuery("SELECT * from fConfBorrow,Conference where fConfBorrow.fid ='"+fid+"' and fConfBorrow.cfid = Conference.cfid");
        ...
        while (rs.next()) 
        {
            ...
            if (etime == null)
                System.out.println(fid+" "+cfid+" "+show_cisbn+" "+show_cname+" "+show_ctitle+" "+show_cauthor+" "+show_cyear+" "+stime.toString());
            else
                System.out.println(fid+" "+cfid+" "+show_cisbn+" "+show_cname+" "+show_ctitle+" "+show_cauthor+" "+show_cyear+" "+stime.toString()+" "+etime.toString());
        ...
        //reserved camera
        rs = stmt.executeQuery("select * from Camera, fCamBorrow where fCamBorrow.fid ='"+fid+"' and fCamBorrow.cam_id=Camera.cam_id ");
        ...
        while(rs.next())
        {
            ...
            Date stime = rs.getDate("stime");
            Date etime = rs.getDate("etime");
            System.out.println(fid+" "+cam_id+" "+make+" "+model+" "+lensConfig+" "+memory+" "+camLocation+" "+stime.toString()+" "+etime.toString());

        }
/*
        rs = stmt.executeQuery("select * from StudyRoom, SRBorrow where SRBorrow.ffid ='"+fid+"' and StudyRoom.srNum = SRBorrow.srNum ");
        while (rs.next()) 
        {
