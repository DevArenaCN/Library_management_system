...
public class fcheckwl {

    static final String jdbcURL 
	= "jdbc:oracle:thin:@ora.csc.ncsu.edu:1521:orcl";

    public static void fcheckwait(String userId) {
        try {
        ...
        //reserved book
		rs = stmt.executeQuery("SELECT * from fBookWL,Books where fBookWL.fid ='"+fid+"' and fBookWL.sb_bid = Books.bid");
		...
		while (rs.next()) {
            ...
            System.out.println(fid+" "+sb_bid+" "+show_bisbn+" "+show_btitle+" "+show_bedition+" "+show_bauthor+" "+show_bpublisher+" "+show_byear+" "+show_blocation);

		}

        //reserved camera
        rs = stmt.executeQuery("select * from Camera, fCamWL where fCamWL.fid ='"+fid+"' and fCamWL.cam_id=Camera.cam_id ");
         ...
         while(rs.next())
        {
            ...
            System.out.println(fid+" "+cam_id+" "+make+" "+model+" "+lensConfig+" "+memory+" "+camLocation);
