...
public class ffine {
    ...
    public static void ffin(String userId) throws ParseException {
       ...
       // searchcam2 = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
        ...
        //camera fine
        String selectot = "select * from fCamBorrow where fid='"+fid+"' and OtMark=1";
        ...
        //book fine
        String selectot2 = "select * from fBookBorrow where fid='"+fid+"' and OtMark=1";
        ...
        String judge = "select * from ffine where fid ='"+fid+"'";
        rs = searchcam.executeQuery(judge);
        if(rs.next())
        {
            String updatesfine="update ffine set bookfine ='"+bfine+"' ,camfine ='" +cfine+"' where fid ='"+fid+"'"; 
            stmt.executeUpdate(updatesfine); 
        }
        else
        {
            String insertsfine="insert into ffine values('"+fid+"' ,'"+bfine+"' ,'"+cfine+" ')";
    ...
    {
        String deletefine = "update ffine set bookfine = 0,camfine = 0 where fid ='"+fid+"'"; 
